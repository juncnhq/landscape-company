...
export default function Sidebar() {
  ...
  return (
    <aside className="w-60 shrink-0 bg-[#07130a] h-full flex flex-col">
      {/* Logo */}
      <div className="px-5 py-6 border-b border-white/5">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-[#328442] flex items-center justify-center font-bold text-white text-sm shrink-0">
            F
          </div>
          <div>
      ...
      <nav className="flex-1 px-3 py-4 space-y-0.5">
        <p className="text-white/20 text-[9px] tracking-widest uppercase px-2 py-2 font-semibold">Nội dung</p>
        {nav.map((item) => {
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-colors ${
                active
                  ? 'bg-[#328442] text-white font-medium'
