...
export default function OurServicesSection() {
  ...
  return (
    <section ref={ref} className="relative bg-gray-50 py-20 md:py-32 overflow-hidden">
      {/* Green glow top-right */}
      <div className="absolute -top-40 right-0 w-[600px] h-[600px] bg-green-500/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="mt-16 md:mt-20 grid grid-cols-3 gap-px bg-gray-200 rounded-2xl overflow-hidden"
        >
          {[
            ...
            <div key={stat.value} className="bg-white px-2 md:px-6 py-5 md:py-8 text-center">
              <p className="text-xl md:text-3xl font-bold text-green-600 mb-1">{stat.value}</p>
