  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-14 py-8 sm:py-14 grid grid-cols-2 sm:grid-cols-3 gap-6 sm:gap-10">
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            <div className="space-y-3">
              <a href="tel:+84901234567" className="flex items-center gap-3 text-sm group">
              ...
              <a href="mailto:info@lapla.vn" className="flex items-center gap-3 text-sm group">
                <div className="w-8 h-8 rounded-full flex items-center justify-center shrink-0 border border-white text-white transition-colors duration-200 group-hover:bg-[var(--color-accent)] group-hover:border-[var(--color-accent)] group-hover:text-[#07130a]">
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
        ...
        {/* ── Bottom bar ── */}
        <div
          className="max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-14 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white"
