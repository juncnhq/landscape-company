  ...
  return (
    <div ref={ref} className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 pb-32">
      ...
      <motion.div
        ...
        className="mb-12"
      >
        <Link href={`/${locale}/news/${featured.slug}`} className="group grid md:grid-cols-2 gap-0 rounded-2xl overflow-hidden border border-green-100 shadow-sm hover:shadow-xl hover:border-green-200 transition-all duration-300">
        ...
        {rest.map((article, i) => (
          ...
          >
            <Link
              ...
              className="group flex flex-col rounded-2xl overflow-hidden border border-green-100 shadow-sm hover:shadow-lg hover:border-green-200 transition-all duration-300 bg-white h-full relative"
            >
