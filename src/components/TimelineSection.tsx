...
export default function TimelineSection() {
  ...
  return (
    <section className="py-16 md:py-28 bg-gradient-to-br from-green-800 to-green-900 overflow-hidden">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-secondary-300 text-xs sm:text-sm font-semibold tracking-widest uppercase mb-3">History</p>
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">{t('title')}</h2>
          <p className="text-white/60 text-base md:text-lg">{t('subtitle')}</p>
        </motion.div>

        <div className="relative">
          {/* Vertical line */}
          <div className="absolute left-[7px] md:left-1/2 top-2 bottom-2 w-px bg-gradient-to-b from-white/0 via-white/25 to-white/0 md:-translate-x-px" />
