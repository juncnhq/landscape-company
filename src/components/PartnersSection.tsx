...
function PartnerModal({ partner, onClose, isVi }: { partner: Partner; onClose: () => void; isVi: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="px-7 pt-7 pb-6" style={{ background: 'linear-gradient(135deg, #16813d 0%, #1a7a30 60%, #2d9e4a 100%)' }}>
        ...
        <div className="px-7 py-6 space-y-5 max-h-[60vh] overflow-y-auto">
          <div className="flex items-center gap-4 bg-[var(--color-surface-base)] rounded-2xl p-4">
            <div className="flex-1">
              <p className="text-xs text-[var(--color-brand)] font-semibold uppercase tracking-wider">{statLabel}</p>
      ...
      >
        {doubled.map((partner, i) => (
          ...
          >
            ...
            <span className="text-[var(--color-text-muted)] text-xs tracking-widest uppercase group-hover:text-white/65 transition-colors whitespace-nowrap">
              {isVi ? partner.sectorVi : partner.sectorEn}
            </span>
          </button>
        ))}
    ...
    <>
      <section ref={ref} className="py-20 md:py-32 bg-[var(--color-surface-base)] relative">
        ...
        <div className="absolute inset-0 pointer-events-none select-none" style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='140' height='140' viewBox='0 0 140 140' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='70' cy='70' r='28' stroke='%2316813d' stroke-width='0.7' fill='none' opacity='0.07'/%3E%3Ccircle cx='70' cy='70' r='14' stroke='%2316813d' stroke-width='0.5' fill='none' opacity='0.05'/%3E%3Cpath d='M70 42 C65 52 60 60 60 70 C60 80 65 86 70 86 C75 86 80 80 80 70 C80 60 75 52 70 42Z' fill='%2316813d' opacity='0.06'/%3E%3Ccircle cx='70' cy='90' r='2.5' fill='%2316813d' opacity='0.08'/%3E%3C/svg%3E")`,
        ...
        <div className="max-w-[1440px] lg:max-w-[80%] mx-auto px-6 sm:px-10 lg:px-14 xl:px-16 2xl:px-24 mb-12 md:mb-16">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            ...
            >
              <p className="inline-flex items-center gap-2 text-xs tracking-[0.3em] uppercase font-semibold text-[var(--color-brand)] mb-3">
