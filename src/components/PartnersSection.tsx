  ...
  return (
    <>
      <section ref={ref} className="py-12 md:py-24 bg-[#f7faf7] relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_0%,rgba(50,132,66,0.05)_0%,transparent_70%)] pointer-events-none" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6">
            {partners.map((partner, i) => (
              <motion.button
                ...
                className="relative bg-white rounded-2xl p-4 md:p-8 flex flex-col items-center justify-center hover:bg-green-50/60 hover:shadow-lg transition-all duration-300 group cursor-pointer border border-gray-100 hover:border-green-200 text-left overflow-hidden"
              >
                {/* Hover accent line at bottom */}
                <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-green-500 to-secondary-400 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left" />
