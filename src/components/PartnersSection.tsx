          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6">
            {partners.map((partner, i) => (
              <motion.button
                ...
                className="bg-white rounded-2xl p-4 md:p-8 flex items-center justify-center hover:bg-green-100 hover:shadow-md transition-all group cursor-pointer border border-transparent hover:border-green-200 text-left"
              >
